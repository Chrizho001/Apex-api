...
ALLOWED_HOSTS = ["https://apex-2ko2.onrender.com", "localhost", "127.0.0.1"]
...
# Mailtrap settings for development email testing
...
CORS_ALLOW_ALL_ORIGINS = False  # 🔒 Keep this off for production
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # ✅ Vite (React)
    "http://127.0.0.1:3000",
    "https://apex-99.vercel.app",  # ✅ just in case
]
